{{-- Monthly/Weekly/Daily P & L - Changes in Stock --}}
<div>
    <h6 class="fw-bold mb-3">
        <i class="bi bi-calendar-range text-primary me-2"></i>{{ ucfirst($periodType) }} P & L - Changes in Stock
    </h6>
        ...
        <table class="table table-hover data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Rs. {{ number_format($period['expenses'], 2) }}</td>
                    <td class="fw-bold {{ $period['net_profit'] >= 0 ? 'profit-positive' : 'profit-negative' }}">
                        Rs. {{ number_format($period['net_profit'], 2) }}
                    </td>
                    <td>
                        @if($period['net_profit'] > 0)
                            <span class="badge bg-success"><i class="bi bi-check-circle me-1"></i>Profit</span>
                        @elseif($period['net_profit'] < 0)
            ...
            <tfoot class="table-secondary">
                <tr>
                    ...
                    <td class="fw-bold">Rs. {{ number_format($totalExpenses, 2) }}</td>
