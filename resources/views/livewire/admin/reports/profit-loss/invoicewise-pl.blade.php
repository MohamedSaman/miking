{{-- Invoicewise Profit/Loss --}}
<div>
    <h6 class="fw-bold mb-3">
        <i class="bi bi-receipt text-primary me-2"></i>Invoicewise Profit/Loss
    </h6>
    ...
    <div class="table-responsive">
        <table class="table table-hover data-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="badge bg-light text-dark">{{ $item['sale']->invoice_number }}</span></td>
                    <td>{{ \Carbon\Carbon::parse($item['sale']->created_at)->format('d M Y') }}</td>
