<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-1" style="color: #2a83df;">Staff Sales Report</h2>
            <p class="text-muted">View all sales created by staff members</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.staff-sales') }}" class="btn btn-outline-primary rounded-2">
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h6 class="text-muted mb-2">Total Staff Sales</h6>
                    <h3 class="fw-bold" style="color: #2a83df;">{{ count($salesData['data'] ?? []) }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <h3 class="fw-bold" style="color: #2a83df;">{{ count($staffMembers) }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h6 class="text-muted mb-2">Partial Status</h6>
                    <h3 class="fw-bold text-warning">{{ count(array_filter($staffSales, fn($s) => $s['status'] === 'partial')) }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <h3 class="fw-bold text-success">{{ count(array_filter($staffSales, fn($s) => $s['status'] === 'completed')) }}</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select class="form-select" wire:model.live="selectedStaff">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" wire:model.live="searchTerm" placeholder="Invoice number or customer name...">
                </div>
            </div>
            <div class="row g-2 mt-2">
                <div class="col-auto">
                    <button class="btn btn-outline-secondary" wire:click="clearFilter">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0 fw-bold" style="color: #2a83df;">
                <i class="bi bi-table me-2"></i>Staff Sales List
            </h5>
        ...
        <div class="card-body p-0">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">No sales data found</p>
                </div>
            @endif
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Sale Information</h6>
                        ...
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Customer Information</h6>
                            <table class="table table-sm table-borderless">
                                <tr>
                    ...
                    <div class="table-responsive mb-4" style="min-height: 20vh !important;">
                        ...
                        <div class="col-md-6 offset-md-6">
                            ...
                            <table class="table table-sm table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end text-warning"><strong>Rs. {{ number_format($selectedSale->due_amount, 2) }}</strong></td>
                                </tr>
                                <tr>
                ...
                <div class="modal-footer bg-light rounded-0">
                    <button type="button" class="btn btn-outline-secondary rounded-0" wire:click="closeViewModal">
