                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select shadow-sm" wire:model.live="salePriceType">
                                ...
                                <option value="cash_credit">Cash & Credit Invoice (Partial)</option>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control form-control-sm text-primary rounded-0" min="0" step="0.01"
            ...
            <div class="card">
                <div class="card-body text-center">
                    <button class="btn btn-primary btn-lg px-5" wire:click="createQuotation"
                        ...
                        <i class="bi bi-file-earmark-plus me-2"></i>Create Quotation [F2]
                    </button>
                </div>
            </div>
        </div>
